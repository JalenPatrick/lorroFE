...
function (_Component) {
  ...
  function record(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "recordStart", function () {
      ...
      mediaRecorder.start();
      console.log("recorder started"); // mediaRecorder.ondataavailable = function(e) {
      //     chunks.push(e.data);
      // }
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "recordStop", function () {
      ...
      mediaRecorder.ondataavailable = function (e) {
        ...
        Object(file_saver__WEBPACK_IMPORTED_MODULE_15__["saveAs"])(audioURL, "sound.wav");
      }; // audio.controls = true;
  ...
  _createClass(record, [{
    ...
    value: function componentDidMount() {
      ...
      navigator.mediaDevices.getUserMedia(constraints).then(function (stream) {
        mediaRecorder = new MediaRecorder(stream); // mediaRecorder.mimeType = 'audio/wav';
    ...
    value: function render() {
      if (this.state.appIsMounted) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          __self: this
        }, " PLAY ")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_4___default.a, {
          container: true,
          xs: 12,
          direction: "row",
          justifyContent: "center",
...
//# sourceMappingURL=record.js.14b51cd35c8c4ed9f1ff.hot-update.js.map