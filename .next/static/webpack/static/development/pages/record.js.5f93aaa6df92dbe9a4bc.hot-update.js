...
var blob = null;
var audioContext, recorder, gumStream;
...
function (_Component) {
  ...
  function record(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "recordStart", function (stream) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "recordStop", function () {
      recorder.stop().then(function (_ref) {
        var blob = _ref.blob,
            buffer = _ref.buffer;
        blob = blob; // buffer is an AudioBuffer

        console.log(buffer);
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "downloadAudio", function () {
      recorder.download(blob, 'lorro-audio');
    });
  ...
  _createClass(record, [{
    ...
    value: function componentDidMount() {
      ...
      audioContext = new (window.AudioContext || window.webkitAudioContext)(); // recorder = new Recorder(audioContext, {
    ...
    value: function render() {
      ...
      if (this.state.appIsMounted) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          __self: this
        }, " STOP "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_12___default.a, {
          variant: "contained",
          color: "secondary",
...
//# sourceMappingURL=record.js.5f93aaa6df92dbe9a4bc.hot-update.js.map