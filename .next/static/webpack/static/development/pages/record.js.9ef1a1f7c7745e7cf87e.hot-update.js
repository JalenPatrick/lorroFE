...
function (_Component) {
  ...
  function record(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "recordStop", function () {// mediaRecorder.stop();
  ...
  _createClass(record, [{
    ...
    value: function componentDidMount() {
      ...
      audioContext = new (window.AudioContext || window.webkitAudioContext)(); // audioCtx = new (window.AudioContext || webkitAudioContext)();
...
//# sourceMappingURL=record.js.9ef1a1f7c7745e7cf87e.hot-update.js.map