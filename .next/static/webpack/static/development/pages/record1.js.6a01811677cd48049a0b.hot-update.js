...
function (_Component) {
  ...
  function record(props) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              console.log('outside url', audioURL);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "submitRecording", function () {// recorder.download(blob, 'lorro-recording')
    ...
    value: function render() {
      if (this.state.appIsMounted) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          ...
          __self: this
        }, "Play Recording ")), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_5___default.a, {
          style: buttonGroup,
          container: true,
          xs: 12,
          direction: "row",
...
//# sourceMappingURL=record1.js.6a01811677cd48049a0b.hot-update.js.map