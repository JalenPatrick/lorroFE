...
function (_Component) {
  ...
  function record(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "recordStop", function () {
      ...
      var reblob = new Blob(blob);
      audioURL = window.URL.createObjectURL(blob); // console.log('recorder on stop', mediaRecorder)
...
//# sourceMappingURL=record1.js.b93a56a03595fc70b798.hot-update.js.map