...
function (_Component) {
  ...
  function results() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "generateScore", function (freq, timing, phonemes) {
      ...
      var pre_score = ((freq + timing + phonemes + 90) / 4).toFixed(2);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getTranscribe", function (trans_url) {
      ...
      if (!_this.state.getTranscribeDone) {
        axios__WEBPACK_IMPORTED_MODULE_21___default.a.get(trans_url).then(function (response) {
          ...
          console.log('after getTranscribe', _this.state);
          return result;
        });
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "matchingWords", function (targetWords) {
      console.log('matching words');
      console.log('in matchingWords', _this.state);

      if (_this.state.transcribeTextSample) {
        var sampleArray = _this.state.transcribeTextSample.split(' ');

        var targetArray = targetWords.split(' ');
  ...
  _createClass(results, [{
    ...
    value: function render() {
      ...
      var wordMatching = this.wordMatching(this.state.wordCompare); // assign the score to the state
      ...
      console.log(transcribe_result, determineWords, lorroScoreRedux); // compareGraphData = this.getCompareData(this.state.freqScore, this.state.ppAccuracyScore, this.state.rawAccuracyScore, determineWords)
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_4__["default"], {
        ...
        __self: this
      }, " ", this.state.postScore === null ? this.state.preScore : this.state.postScore, " "), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_10__["Typography"], {
        variant: "h5",
        style: {
          fontFamily: 'Merienda',
          color: '#8884d8'
        ...
        __self: this
      }, " ", this.state.postScore === null ? "Awaiting word transcription..." : "With word transcription!", " "))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_5___default.a, {
        style: sampleCard,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 401
...
//# sourceMappingURL=results.js.3e084b7ce48cd90b0c37.hot-update.js.map