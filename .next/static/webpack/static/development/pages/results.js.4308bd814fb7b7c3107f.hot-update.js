...
function (_Component) {
  ...
  function results() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getCompareData", function (freq, timing, phonemes, sampleSize, targetSize) {
      console.log(sampleSize, targetSize);
      var pitchObject = {
      ...
      var timingObject = {
        ...
        value: Math.round(Math.abs(sampleSize - targetSize) / Math.abs(targetSize) * 100),
        fullMark: 100
      };
  ...
  _createClass(results, [{
    ...
    value: function render() {
      ...
      if (this.state.t_frequencies) {
        var _lorroScore = this.generateScore(this.state.freqScore, this.state.ppAccuracyScore, this.state.rawAccuracyScore, this.state.freqScore.length, this.state.t_frequencies.length);
      }
...
//# sourceMappingURL=results.js.4308bd814fb7b7c3107f.hot-update.js.map