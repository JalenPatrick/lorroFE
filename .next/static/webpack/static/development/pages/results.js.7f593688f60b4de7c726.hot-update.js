...
function (_Component) {
  ...
  _createClass(results, [{
    ...
    value: function render() {
      ...
      lorroScoreRedux = this.generateScore2(this.state.freqScore, this.state.ppAccuracyScore, this.state.pacingScore, this.state.word_score);
      compareGraphData = this.getCompareData(this.state.freqScore, this.state.ppAccuracyScore, this.state.pacingScore, this.state.word_score); // console.log(transcribe_result, determineWords, lorroScoreRedux)
...
//# sourceMappingURL=results.js.7f593688f60b4de7c726.hot-update.js.map