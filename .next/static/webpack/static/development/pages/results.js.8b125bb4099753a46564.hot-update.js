...
function (_Component) {
  ...
  _createClass(results, [{
    ...
    value: function render() {
      ...
      var lorroScore = this.generateScore(this.state.freqScore, this.state.ppAccuracyScore, this.state.rawAccuracyScore, this.state.freqScore.length, this.state.t_frequencies.length);
...
//# sourceMappingURL=results.js.8b125bb4099753a46564.hot-update.js.map