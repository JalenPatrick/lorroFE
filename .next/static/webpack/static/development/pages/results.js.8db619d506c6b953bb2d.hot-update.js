  ...
  function results() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "matchingWords", function (targetWords, sampleWords) {
      ...
      if (_this.state.transcribeTextSample) {
        ...
        console.log(intersect); // console.log(intersect.length, targetArray.length)

        var error = Math.abs(targetArray.length - sampleArray.length) / targetArray.length;
        var raw = intersect.length / targetArray.length;
...
//# sourceMappingURL=results.js.8db619d506c6b953bb2d.hot-update.js.map