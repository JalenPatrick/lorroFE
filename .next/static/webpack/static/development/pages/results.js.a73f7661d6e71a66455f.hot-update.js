  ...
  _createClass(results, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        ...
        var process_url, transcribe_url, test, tar, file, sendObj, transcribe;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log('results', sendObj.stringify());
                _context.next = 10;
                return axios__WEBPACK_IMPORTED_MODULE_20___default.a.post(process_url, sendObj).then(function (response) {
...
//# sourceMappingURL=results.js.a73f7661d6e71a66455f.hot-update.js.map