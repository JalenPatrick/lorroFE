...
function (_Component) {
  ...
  _createClass(results, [{
    ...
    value: function render() {
      ...
      var lorroScore = this.generateScore(this.state.freqScore, this.state.ppAccuracyScore, this.state.rawAccuracyScore, freqSampleData.length, freqTargetData.length);
...
//# sourceMappingURL=results.js.aeac882d1cd9ac0563dd.hot-update.js.map