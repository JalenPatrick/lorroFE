...
function (_Component) {
  ...
  _createClass(results, [{
    ...
    value: function render() {
      ...
      compareGraphData = this.getCompareData(this.state.freqScore, this.state.pacingScore, this.state.rawAccuracyScore, this.state.wordScore); // console.log(transcribe_result, determineWords, lorroScoreRedux)
...
//# sourceMappingURL=results.js.c9f817a4e2f35f063ba9.hot-update.js.map