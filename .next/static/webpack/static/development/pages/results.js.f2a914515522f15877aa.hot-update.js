...
function (_Component) {
  ...
  _createClass(results, [{
    ...
    value: function render() {
      ...
      compareGraphData = this.getCompareData(this.state.freqScore, this.state.pacingScore || this.state.ppAccuracyScore, this.state.rawAccuracyScore, this.state.wordScore || 80); // console.log(transcribe_result, determineWords, lorroScoreRedux)
...
//# sourceMappingURL=results.js.f2a914515522f15877aa.hot-update.js.map