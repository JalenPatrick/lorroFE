...
function (_Component) {
  ...
  function results() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getCompareData", function (freqArray, wordArray) {
      var avgFreq, totalSum;
      var freqArrayNoSilence = [];
  ...
  _createClass(results, [{
    ...
    value: function render() {
      ...
      var graphData = this.getFreqData(this.state.frequencies, this.state.rawPhonemes, this.state.noteProgression);
...
//# sourceMappingURL=results.js.fa777a2bf9749dfd3ea3.hot-update.js.map