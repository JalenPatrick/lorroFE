  ...
  _createClass(results, [{
    ...
    value: function render() {
      ...
      if (this.state.t_frequencies) {
        lorroScore = this.generateScore(this.state.freqScore, this.state.ppAccuracyScore, this.state.rawAccuracyScore, this.state.freqScore.length, this.state.t_frequencies.length);
      }
...
//# sourceMappingURL=results.js.fac4596360bd7ab296e9.hot-update.js.map