...
function (_Component) {
  ...
  function upload() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "changeTarget", function (event, key) {
      console.log(key); // console.log(event.target.className)
      // this.setState({
  ...
  _createClass(upload, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_5__["default"], {
        ...
        key: "test",
        onClick: this.changeTarget("british"),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 116
        },
...
//# sourceMappingURL=upload.js.b8f164cf0d290d54b5e0.hot-update.js.map